...
// ********************************************* 함수의 원형(prototype) ************************************ ################이해 중요#################~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`시험출제
	// 원형 선언(function prototype): 함수의 몸체 대신에 ;을 사용하며, 선언부; 형식을 가지는 것이 원형 선언!!
		// 매개변수 의 변수 명을 생략하고 type만 써줘도 된다
	
#define _CRT_SECURE_NO_WARNINGS
#include <stdio.h> // printf나 scanf 함수의 원형(prototype)이 들어있다!!
#include<math.h>


long long facto(int n) {	//recursion, recursive call == 재귀호출 == 순환 호출 --> 자기 자신을 호출하는 함수!!!!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`시험출제q
							// 재귀(순환)호출
	if (n == 0)
		return 1;
	else
